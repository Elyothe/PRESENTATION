...
namespace API.Migrations
{
    ...
    [Migration("20241217142433_UpdateUserSuccess")]
    partial class UpdateUserSuccess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.succes", b =>
                {
                    b.Property<int>("idSucces")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("idSucces"));

                    b.Property<string>("libelleSucces")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("API.Models.userSucces", b =>
                {
                    b.Property<int>("idUserSucces")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("idUserSucces"));
                    ...
                    b.HasKey("idUserSucces");

                    b.HasIndex("idSucces");

                    b.HasIndex("idUser");

                    b.ToTable("UserSucces");
                });
            ...
            modelBuilder.Entity("API.Models.userSucces", b =>
                {
                    b.HasOne("API.Models.succes", "Succes")
                        .WithMany("UserSucces")
                        .HasForeignKey("idSucces")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
