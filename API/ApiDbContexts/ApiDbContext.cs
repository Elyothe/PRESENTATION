...
namespace API.ApiDbContexts
{
    public class ApiDbContext : DbContext
    {
        ...
        public DbSet<userSucces> UserSucces { get; set; } // Ajout de la DbSet pour la table intermédiaire
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    ...
    modelBuilder.Entity<succes>()
        .HasMany(s => s.UserSucces) // Un Success peut avoir plusieurs UserSucces
        .WithOne(us => us.Succes) // Un UserSucces a un Success
        .HasForeignKey(us => us.idSucces) // Clé étrangère
        .OnDelete(DeleteBehavior.Restrict);
